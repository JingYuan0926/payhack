...
const DailySum = ({ showPopup, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[9999]">
      ...
      {/* Spin Wheel Popup */}
      {showSpinWheel && (
        <div className="relative z-[10000] w-[800px] mx-auto">
              ...
              <div className="p-12">
                ...
                <div className="space-y-8">
                  ...
                  <div className="p-6 bg-green-50 rounded-lg border-4 border-green-200">
                    <h3 className="text-3xl font-bold mb-4 text-green-600">Budget Status</h3>
                    <div className="space-y-3">
                      <p className="text-2xl">Remaining budget: <span className="font-bold">$650</span></p>
                      <p className="text-green-600 font-bold text-2xl">Status: On track! 🎯</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8 bg-yellow-50 rounded-lg border-4 border-yellow-200">
                  <ul className="space-y-6">
                    <li className="flex items-start space-x-4">
                      ...
                      <span className="text-2xl">Consider reducing spending on coffee - try making it at home!</span>
                    </li>
                    <li className="flex items-start space-x-4">
                      <span className="text-3xl">🌟</span>
                      <span className="text-2xl">Great job staying within your grocery budget this week!</span>
                    </li>
                    <li className="flex items-start space-x-4">
                      <span className="text-3xl">📝</span>
